...
const features = [
  ...
  { fnum:'Chapter 8', title:'Silence, Without Missing Foc Lock',
    desc:"Want the world to go quiet while you study, but still hear from Foc Lock itself? Turn on Do Not Disturb During Sessions and your phone silences every other app's notifications the moment a session starts — while Foc Lock's own check-ins and alerts still come through loud and clear. No more choosing between deep focus and staying honest with yourself." },
  { fnum:'Chapter 9', title:'Minimize Without Losing the Timer',
    desc:"Need to check something else without breaking your session? Minimize it into a small floating timer that stays on screen while you use the rest of the app. Step out of Foc Lock entirely — home screen, another app — and the timer follows you there too, floating over everything as a real Picture-in-Picture window, counting down until you come back." },
  { fnum:'Chapter 10', title:'Progress & History',
  ...
  { fnum:'Chapter 11', title:'Foc Space — Your Study Tools',
   ...
   { fnum:'Chapter 12', title:'Foco — Your AI Study Buddy',
  ...
  { fnum:'Chapter 13', title:'Friends & Achievements',
  ...
  { fnum:'Chapter 14', title:'Synced Across Every Device',
  ...
  { fnum:'Chapter 15', title:'Made for Every Screen',
  ...
  { fnum:'Chapter 16', title:'More — Profile & Settings',
  ...
  { fnum:'Chapter 17', title:'Ready to Lock In?',
