...
const features = [
  ...
  { fnum:'Chapter 8', title:'Silence, Without Missing Foc Lock',
    desc:"Want silence while you study, but still hear from Foc Lock? Turn on Do Not Disturb During Sessions and your phone mutes every other app's notifications the moment a session starts — while Foc Lock's own check-ins still get through. Deep focus without losing accountability." },
  { fnum:'Chapter 9', title:'Minimize Without Losing the Timer',
    desc:"Need to check something else without breaking your session? Minimize it into a small floating timer that stays on screen while you use the rest of the app. Step out entirely — home screen, another app — and it follows as a real Picture-in-Picture window, counting down until you're back." },
